...
Static lViagem3   := ExistFunc("TMSA060") .And. AliasInDic("DM3")
...
If	nOpcx == 5	//-- Excluir
	...
	//-- Deleta tabelas específicas da viagem modelo 3
...
If nOpcx <> 3
	cQuery := "SELECT COUNT(*) DUD_COUNT FROM "
...
If nOpcx == 3 .Or. nOpcx == 4
	...
	cQuery += "     AND DUD.D_E_L_E_T_    = ' '"
	cQuery += "     AND EXISTS ( "
	cQuery += "           SELECT 1 FROM " + RetSqlName("DVM")
